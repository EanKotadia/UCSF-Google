...
export const HARDCODED_CATEGORIES: Record<string, Partial<Category>> = {
  'cricket': {
    category_type: 'sport',
    team_size: '9 Players',
    on_field: '9 Players (7 Boys, 2 Girls)',
...
• MONEY BALL RULE: When a girl is batting, she will be designated as the Money Ball Player. All runs scored by her will be doubled (1=2, 4=8, 6=12).`,
  ...
  'football': {
    category_type: 'sport',
    team_size: '7 Players',
    on_field: '5 Players (4 Outfield, 1 GK)',
    duration: '10m + 2m + 10m',
...
• No external assistance or electronic devices.`,
    submission_format: 'Trials conducted alongside sports trials.'
  },
  'dance': {
...
• Offensive language and unsafe acts are not permitted.`,
    submission_format: 'Upload a 1–2 minute video for screening.'
  },
  'music': {
    category_type: 'cultural',
    team_size: 'Duet/Solo',
...
• Song choices must be school-appropriate.`,
    submission_format: 'Upload a 1-min video for screening.'
  },
  'graffiti-art': {
    category_type: 'cultural',
...
• Teams present concept in 2 minutes.`,
    submission_format: 'Upload a concept note along with one photo/sketch for the audition.'
  },
  'cinematography': {
    category_type: 'cultural',
    team_size: 'Group',
...
• Films must be originally created by students.`,
    submission_format: 'Upload a high-resolution poster, PPT, or a relevant video.'
  },
  'theatre': {
    category_type: 'cultural',
    team_size: 'Duet/Solo',
...
• Content must remain respectful and free from offensive remarks.`,
    submission_format: 'Upload a 1-minute video for the prelims.'
  }
};
